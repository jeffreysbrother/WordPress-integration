...
(function( $ ) {  //This functions first parameter is named $
    ...
    $.redux.customizer.init = function() {
        $( '.accordion-section.redux-section' ).click(
            function() {
                ...
                if ( $( this ).hasClass( 'open' ) ) {
                    ...
                    var width = $( this ).parents( '.redux-panel:first' ).attr( 'data-width' );
                    if ( !width ) {
        ...
        $( '.redux-panel .accordion-section-title' ).click(
            function() {
                if ( $( this ).parent().attr( 'data-width' ) != "" && $( 'body' ).width() > 639 ) {
                    $( document ).find( 'form#customize-controls' ).attr(
                        'style', 'width:' + $( this ).parent().attr( 'data-width' ) + ';'
                    );
                    $( document ).find( '.wp-full-overlay' ).attr(
                        'style', 'margin-left:' + $( this ).parent().attr( 'data-width' ) + ';'
                    );
                }
            }
        );
    ...
    redux.customizer.save = function( $obj, $container ) {
        ...
        var $parent = $obj.parents( '.redux-field-container:first' );
        ...
        //$parent.closest('.redux-customizer-input' ).value($data);
        //console.log(jQuery($container).attr());
        //console.log(jQuery($obj ).html());
        //console.log($obj.html());
        //setting.set( $.extend( {}, setting.get() || {}, { url: this.value } ) );
    };
