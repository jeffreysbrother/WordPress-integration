  ...
  ob_start(); ?>
      <section class="carousel_outerrim loading">
        <div id="image-carousel-gallery-<?php echo esc_attr($gallery_id); ?>" class="fredcarousel fadein-carousel" style="overflow:hidden; height: <?php echo esc_attr($height);?>px">
            <div class="gallery-carousel initimagecarousel" data-carousel-container="#image-carousel-gallery-<?php echo esc_attr($gallery_id); ?>" data-carousel-transition="<?php echo esc_attr($transpeed); ?>" data-carousel-auto="<?php echo esc_attr($autoplay);?>" data-carousel-speed="<?php echo esc_attr($speed);?>" data-carousel-id="galleryimgcarousel-<?php echo esc_attr($gallery_id); ?>">
              <?php 
                            ...
                            foreach ($attachments as $id => $attachment) {
                                ...
                                $image = aq_resize($attachment_url, null, $height, false, false);
                                  ...
                                  echo '<a href="'.esc_url($attachment_url).'" class="imgcarousellink">';
