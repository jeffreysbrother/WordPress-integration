<footer id="containerfooter" class="footerclass" role="contentinfo">
  <div class="container">
  	<div class="row">
  		<?php global $virtue_premium; if(isset($virtue_premium['footer_layout'])) { $footer_layout = $virtue_premium['footer_layout']; } else { $footer_layout = 'fourc'; }
        ...
        <div class="footercredits clearfix">
        	...
        	<p><?php global $virtue_premium; $footertext = $virtue_premium['footer_text']; echo do_shortcode($footertext); ?></p>
    	</div><!-- credits -->
    </div><!-- container -->
</footer>
