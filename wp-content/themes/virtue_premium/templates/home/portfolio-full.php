<div class="home-portfolio clearfix home-margin home-padding">
	<?php global $virtue_premium; if(!empty($virtue_premium['portfolio_full_title'])) {$port_full_title = $virtue_premium['portfolio_full_title']; } else { $port_full_title = '';} ?>
		...
		if($hp_orderby == 'menu_order') {$p_order = 'ASC';} else {$p_order = 'DESC';}
					...
					if(isset($virtue_premium['portfolio_full_show_excerpt']) && $virtue_premium['portfolio_full_show_excerpt'] == 1) {$portfolio_item_excerpt = true;} else {$portfolio_item_excerpt = false;}
